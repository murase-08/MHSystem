    ...
    if texts:
        for text in texts:
            ...
            if text.description == "1":  # '1' を特定
                ...
                print("以下はTDIシステムサービスのy_cordinatesの値です。")
...
def save_debug_image(image, step_name, page_num):
    file_name = f"{output_dir}/page2_{page_num + 1}_{step_name}.png"
...
def trim_image(image,y_coordinates):
    ...
    x, y, width, height = 490, y_coordinates-20, 1150, 3830  # 適切な座標を設定
...
def process_pdf_for_table(pdf_path):
    ...
    for page_num, page_image in enumerate(pages):
        ...
        image_path = f"{output_dir}/page2_{page_num + 1}.png"
...
def main():
    # PDFファイルのパス
    # pdf_path = '/Users/yuri23/Downloads/202405_勤怠_大平.pdf'
    pdf_path = 'C:/Users/user/Desktop/work_data/大平_TDIシステムサービス.pdf'
