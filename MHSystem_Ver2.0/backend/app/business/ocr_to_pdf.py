...
# テーブル構造を推定する関数
def reconstruct_table_from_ocr(text_data, y_tolerance=10, x_tolerance=10):
...
def create_pdf_with_table_structure_and_grid(text_data, processed_images,customer_file_path, specific_customer_file_path, y_tolerance=50, x_tolerance=25):
    # 出力ディレクトリを指定
